...
<div class="mb-4">
    ...
    <p class="text-secondary mb-0">
        Informasi lengkap produk inventaris
    </p>
</div>
    ...
    <div class="row g-4">
        ...
        <div class="col-md-6">
            ...
            <div class="fw-semibold fs-6">
                <?= htmlspecialchars($product['kode_barang']) ?>
            </div>
        ...
        <div class="col-md-6">
            ...
            <div class="fw-semibold">
                <?= htmlspecialchars($product['nama_distributor']) ?>
            </div>
            ...
            <div>
                <?php if ($product['stock'] <= $product['stock_min']): ?>
                    ...
                    <span class="badge bg-danger fs-6">
                        <?= $product['stock'] ?>
                        <?= htmlspecialchars($product['satuan']) ?>
                    </span>
        ...
        <div class="col-md-6">
            ...
            <div>
                <?= date('d F Y H:i', strtotime($product['createdAt'])) ?>
            </div>
        ...
        <div class="col-md-6">
            ...
            <div>
                <?= date('d F Y H:i', strtotime($product['updatedAt'])) ?>
            </div>
